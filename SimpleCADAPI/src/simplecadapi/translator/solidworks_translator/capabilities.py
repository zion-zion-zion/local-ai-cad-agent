"""Static capability declaration for the SolidWorks translator backend."""
...
OP_SUPPORT: Dict[str, OperationCapability] = {
    op: OperationCapability(
        ...
        reason="The SolidWorks runtime has no implementation for this canonical operation.",
    )
...
for _op in _GEOMETRY_OPS:
    OP_SUPPORT[_op] = OperationCapability(
        ...
        reason=(
            "The generated automation script reconstructs this operation through "
            "SolidWorks COM geometry and feature APIs."
        ),
    )
for _op in _PRODUCT_OPS:
    OP_SUPPORT[_op] = OperationCapability(
        ...
        reason=(
            ...
            "without promising an equivalent native SolidWorks feature."
        ),
    )
